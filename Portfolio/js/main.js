...
// attempt at fixing live today on relaod
document.addEventListener("DOMContentLoaded", function () {
  const hiddenProjects = document.querySelectorAll(".past-works");
...
$(document).ready(function () {
  ...
  // Set the initial active button and filter the content
  const $liveTodayBtn = $(
    ".projects .the-button-legion button[data-filter='.live-today']"
  );
  $liveTodayBtn.addClass("active");
  $(".projects .grid").isotope({ filter: ".live-today" });
